...
def get_team_settings(locked, exportadapters):
    ...
    try:
        ...
        if exportadapters:
            ...
            prioritiesExport = {
                "Wi-Fi": {"value": "always", "locked": locked},
            ...
            monthlyLimitExport = {
                "Wi-Fi": {
                    "value": {"monthlyLimit": 0, "monthlyResetDay": 0},
                    "locked": locked,
                },
                "Ethernet": {
                    "value": {"monthlyLimit": 0, "monthlyResetDay": 0},
            ...
            perConnectionEncryptionSettingExport = {
                "Wi-Fi": {"value": encyptdefault, "locked": locked},
            ...
            for adapter in adapters:
                ...
                for perConnectionEncryptionSetting in perConnectionEncryptionSettings:
                    ...
                    if (
                        perConnectionEncryptionSetting["adapterID"]
                        == adapter["adapterID"]
                    ):
                        encryptExport = {}
                        encryptExport["value"] = perConnectionEncryptionSetting[
                            "encrypted"
                        ]
                ...
                if "dataUsage" in adapter:
                    ...
                    monthlyLimitExport[adaptertype]["value"]["monthlyLimit"] = limits[
                        "usageMonthlyLimit"
                    ]
                    monthlyLimitExport[adaptertype]["value"][
                        "monthlyResetDay"
                    ] = limits["usageMonthlyResetDay"]
            ...
            if anyperconnection:
                settingsExport[
                    "perConnectionEncryptionSetting"
                ] = perConnectionEncryptionSettingExport
            if anylimits:
        ...
        settingsExport["connectMethod"]["value"] = speedify.connectmethod_as_string(
            connectmethodsettings
        )
...
if len(sys.argv) > 1:
    if "lock" in sys.argv:
        lockoutput = True
currentsettings = get_team_settings_as_json_string(
    locked=lockoutput, exportadapters=exportAdapters
)
