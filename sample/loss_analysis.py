...
class speedify_callback:
    ...
    def __init__(self):
        ...
        self.wifi_loss_send = [0.0]
        self.wifi_loss_receive = [0.0]
    ...
    def __call__(self, callback_input):
        ...
        if callback_input[0] == "connection_stats" :
            # logging.info("connection_Stats" + (str(callback_input)))
    ...
    def connection_callback(self, callback_input):
        #logging.info("input " + str(callback_input))
        today = datetime.datetime.now();
        callback_input.append(today.isoformat());
        print(json.dumps(callback_input))
